...
namespace Kontrer.OwnerServer.CustomerService.Data.Accommodation.EntityFramework
{
    ...
    {       
        ...
        public EfAccommodationRepository(DbContext dbContext) 
            : base(dbContext,x=>x.AccommodationId)
        {
          
        }

        protected override int GetModelId(FinishedAccommodationModel model)
        {
            return model.AccommodationId;
        }

        protected override void SetEntityId(int id, FinishedAccommodationEntity entity)
        {
            entity.AccommodationId = id;
        }

        protected override FinishedAccommodationEntity ToEntity(FinishedAccommodationModel model)
        {
        ...
        protected override FinishedAccommodationModel ToModel(FinishedAccommodationEntity entity)
        {
        ...
        //private void AddEntity(FinishedAccommodationEntity entity)
        //{
        ...
        //public void TryAdd(FinishedAccommodationModel model)
        //{
        //    var entity = ToEntity(model);
        //    if (dbContext.Accommodations.Find(model.AccommodationId) is null)
        //    {
        //        AddEntity(entity);
        //    }
