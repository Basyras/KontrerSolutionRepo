...
namespace Basyc.MessageBus.Client
{
	public interface IByteMessageBusClient
	{
		...
		Task<byte[]> RequestAsync(string requestType, CancellationToken cancellationToken = default);
		Task<OneOf<byte[], ErrorMessage>> RequestAsync(string requestType, byte[] requestData, CancellationToken cancellationToken = default);
